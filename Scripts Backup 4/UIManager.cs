...
public class UIManager : MonoBehaviour
{
    ...
    public Toggle calculateAlphaT, showPointsT;
    ...
    void Start()
    {
        ...
        showPointsT.onValueChanged.AddListener        (delegate { OnChangeShowPoints(showPointsT.isOn);});
    }
    ...
    {
        triangulationManager.OnChangeShowPoints(value);
    }
